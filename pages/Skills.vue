<template>
  <div class="bg-base-200">
    <div class="pt-8"><h1 class="title">Skills</h1></div>
    <div class="mt-8">
    ...
    <div class="card glass w-96 bg-base-100 shadow-xl mx-auto my-8">
      <figure class="px-10 pt-10">
        <img src="/images/Arrive.png" alt="Shoes" class="rounded-xl" />
      </figure>
      <div class="card-body items-center text-center">
        ...
        <p>Logistics</p>
        <h2 class="card-title text-xl font-bold text-secondary">Start Date</h2>
        <p>July 5th, 2022</p>
